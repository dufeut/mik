...
//! It demonstrates how to create a basic WASI HTTP host configuration.
//!
//! ## What This Example Shows
//!
//! - Creating a `HostBuilder` with minimal configuration
...
//! 2. Call `host.serve(addr).await` within a tokio runtime
//!
//! ## Related Documentation
//!
//! - [`mik::runtime::HostBuilder`] - The builder used to configure the host
//! - [`mik::runtime::Host`] - The runtime that serves WASM components
...
fn main() -> Result<()> {
    // =========================================================================
    // Step 1: Create a HostBuilder
    // =========================================================================
    //
    // The HostBuilder provides a fluent API for configuring the WASI HTTP
    // runtime. You can either:
    // - Use `HostBuilder::new()` for programmatic configuration
    // - Use `HostBuilder::from_manifest("mik.toml")` to load from a file
    //
    // Here we use the programmatic approach to show all configuration options.

    let builder = mik::runtime::HostBuilder::new()
        ...
        // Default is 3000. Common alternatives: 8080, 8000
        .port(3000)
    ...
    // =========================================================================
    //
    // You can query the builder to verify configuration before building.

    println!("=== mik Hello World Example ===\n");
    println!("Configuration:");
    println!("  Port: {}", builder.get_port());

    // =========================================================================
    // Step 3: Build the Host (Optional)
    // =========================================================================
    //
    // In a real application, you would call `.build()` to create the Host,
    // then call `.serve(addr).await` to start serving requests.
    //
    ...
    //     let host = mik::runtime::HostBuilder::new()
    //         .modules_dir("modules/")
    //         .port(3000)
    //         .build()?;
    //
    ...
    // =========================================================================
    // Step 4: Alternative - Load from Manifest
    // =========================================================================
    //
    // In production, you typically load configuration from mik.toml:
    //
    // ```rust
    // let builder = mik::runtime::HostBuilder::from_manifest("mik.toml")?
    //     .port(8080);  // Override specific values if needed
    // ```
    //
